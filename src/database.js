...
const database = [
  {
    ...
    published: format(new Date(2023, 4, 3), 'dd/MM/yyyy'),
  },
...

  {
    category: "lit",
    id: "lit1",
    src: "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1621713120i/426504.jpg",
    artist: "Jorge Luis Borges",
    release: "Ficciones",
    subtitle: "The Spock's feeling young",
    content: `The author is a master of mixing fantasy and philosophy. He has been credited as a pioneer in magical realism in Latin American literature. In this classic collection, most stories are almost as much essays as they are short stories.
    ...
    published: format(new Date(2023, 4, 4), 'dd/MM/yyyy'),
  }
];
